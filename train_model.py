...
plt.savefig("plots/random_forest_actual_vs_predicted.png")
plt.show()
...
plt.tight_layout()
plt.savefig("plots/linear_regression_actual_vs_predicted.png")
plt.show()
...
plt.tight_layout()
plt.savefig("plots/random_forest_residuals.png")
plt.show()
